...
import { LeaveReview, type LeaveReviewRow } from "@/components/admin/leave-review";
...
export default async function AdminAttendancePage() {
  ...
  const [staffRes, todayRes, leavesRes] = await Promise.all([
  ...
  return (
    <div>
      ...
      <LeaveReview leaves={leaves} canWrite={can(auth, "attendance", "write")} />
    </div>
  );
}
